...
- Validação automática de formulários (HTML5)
- Imagens otimizadas e multimídia

## Como rodar o projeto

Abra qualquer arquivo `.html` em seu navegador favorito. O projeto é responsivo e funciona em dispositivos móveis e desktops.